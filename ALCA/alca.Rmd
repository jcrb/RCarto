...
Les fichiers Shapefile sont dans le dossier __CartographieR/IGN_GEOFLA_2014__.
...
------------
```{r}
library("OpenStreetMap", lib.loc="/Library/Frameworks/R.framework/Versions/3.1/Resources/library")
