...
x <- which(com_rge$propsupouegal75 == 0)
x
for(i in x){
...
```{r}
plot(ght5)
text(coordinates(ght5), as.character(round(x[names(ght5)] * 100, 2)))

coul = cut(x, breaks = 5, labels = brewer.pal(n = 5, name = "Blues"))
plot(ght5, col = as.character(coul[as.integer(names(ght5))]), main = "% de 75 ans et plus", axes = TRUE)
text(coordinates(ght5), as.character(round(x[names(ght5)] * 100, 2)))
...
plot(ght5, col = as.character(coul[as.integer(names(ght5))]), main = "% de 18 ans et moins", axes = TRUE)
text(coordinates(ght5), as.character(round(x[names(ght5)] * 100, 2)))
```
...
plot(ght5, col = as.character(coul[as.integer(names(ght5))]), main = "% de 18 à 75 ans", axes = TRUE)
text(coordinates(ght5), as.character(round(x[names(ght5)] * 100, 2)))
