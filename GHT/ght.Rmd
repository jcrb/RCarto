...
# ensemble des communes constituant les GHT de la RGE. Lise transmise par E.Lagille
ght2 <- read.csv2("~/Downloads/Liste_GrandEst_COM_CodePMSI_GHT_27102016_VF.csv")
...
names(a)
```
__a__ est un spatialPolygonDataFrame => possède un dataFrame et plot(a) dessine les GHT fe l'est avec les communes.
